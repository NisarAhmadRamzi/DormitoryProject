...
//   const dashboardRoute = dashboardRouteMap[role] || '/dashboard'
...
//             {hasPermission(user, 'all students') && (
//               <li>
...
//               </li>
//             )}
//             {hasPermission(user, 'all complaints') && (
//               <li>
...
//             {hasPermission(user, 'all libraries') && (
//               <li>
...
//               </li>
//             )}
//             {hasPermission(user, 'all library students') && (
//               <li>
...
//               </li>
//             )}
//             {hasPermission(user, 'all borrowed books') && (
//               <li>
...
//               </li>
//             )}
//             {hasPermission(user, 'all expenses') && (
//               <li>
...
//               </li>
//             )}
//             {hasPermission(user, 'all supports') && (
//               <li>
...
//               </li>
//             )}
//             {hasPermission(user, 'all permissions') && (
//               <li>
...
import { HiOutlineHomeModern } from 'react-icons/hi2'
import { IoIosArrowForward } from 'react-icons/io'
import { IoBedOutline, IoKeyOutline } from 'react-icons/io5'
import { LuBadgeCheck, LuUsers } from 'react-icons/lu'
import { MdOutlineLibraryBooks } from 'react-icons/md'
import {
  PiCurrencyDollarSimpleBold,
...
function MainNav() {
  ...
  const financePermissions = ['all fees', 'all expenses', 'all supports']
  const settingsPermissions = ['all roles', 'all permissions']
  ...
  return (
    <nav>
      <NavList>
        ...
        {/* Dormitory Management */}
        {hasAnyPermission(dormitoryPermissions) && (
          <Category>
            <CategoryHeader
              onClick={() => toggleCategory('dormitory')}
              dir={dir}
            >
              {t('dormitoryManagement')}
              <ArrowIcon open={openCategory === 'dormitory'} dir={dir} />
        ...
        {/* Library Management */}
        {hasAnyPermission(libraryPermissions) && (
          <Category>
            <CategoryHeader onClick={() => toggleCategory('library')} dir={dir}>
              {t('libraryManagement')}
              <ArrowIcon open={openCategory === 'library'} dir={dir} />
        ...
        {/* Finance */}
        {hasAnyPermission(financePermissions) && (
          <Category>
            <CategoryHeader onClick={() => toggleCategory('finance')} dir={dir}>
              {t('finance')}
              <ArrowIcon open={openCategory === 'finance'} dir={dir} />
        ...
        {/* Settings */}
        {hasAnyPermission(settingsPermissions) && (
          <Category>
            <CategoryHeader
